...
const buttonVariants = cva(
  ...
  'bg-black text-white hover:bg-gray-900 px-7 py-1 text-sm rounded-sm font-semibold',
  {
    variants: {
      variant: {
        default:
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ className, children, href, variant, size, ...props }, ref) => {
  if (href) {
    return (
      <Link
        href={href}
